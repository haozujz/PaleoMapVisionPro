...
func fetchSnapshot(coord: CLLocationCoordinate2D) async throws -> UIImage {
...
func fetchScene(coord: CLLocationCoordinate2D) async throws -> MKLookAroundScene {
